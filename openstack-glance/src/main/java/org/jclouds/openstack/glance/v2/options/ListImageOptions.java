 ...
 */
package org.jclouds.openstack.glance.v2.options;

import static org.jclouds.openstack.glance.v2.domain.Image.CONTAINER_FORMAT;
import static org.jclouds.openstack.glance.v2.domain.Image.DISK_FORMAT;
import static org.jclouds.openstack.glance.v2.domain.Image.IS_PUBLIC;
import static org.jclouds.openstack.glance.v2.domain.Image.MIN_DISK;
import static org.jclouds.openstack.glance.v2.domain.Image.MIN_RAM;
import static org.jclouds.openstack.glance.v2.domain.Image.NAME;
import static org.jclouds.openstack.glance.v2.domain.Image.PROTECTED;
import static org.jclouds.openstack.glance.v2.domain.Image.SIZE_MAX;
import static org.jclouds.openstack.glance.v2.domain.Image.SIZE_MIN;
import static org.jclouds.openstack.glance.v2.domain.Image.STATUS;

import java.util.Date;

import org.jclouds.openstack.glance.v2.domain.ContainerFormat;
import org.jclouds.openstack.glance.v2.domain.DiskFormat;
import org.jclouds.openstack.glance.v2.domain.Image.Status;
import org.jclouds.openstack.v2_0.options.PaginationOptions;

/**
 * <h2></h2>Usage</h2> The recommended way to instantiate a ListImageOptions
 * object is to statically import ListImageOptions.Builder.* and invoke a static
 * creation method for each option as needed:
 * <p/>
 * <code>
 * import static org.jclouds.openstack.glance.v2_0.options.ListImageOptions.Builder.*
 * 
 * 
...
public class ListImageOptions extends PaginationOptions {
   ...
   public ListImageOptions containerFormat(ContainerFormat containerFormat) {
      queryParameters.put(CONTAINER_FORMAT, containerFormat.toString());
      return this;
   }
   ...
   public ListImageOptions diskFormat(DiskFormat diskFormat) {
      queryParameters.put(DISK_FORMAT, diskFormat.toString());
      return this;
   }
   ...
   public ListImageOptions minRam(long ram) {
      queryParameters.put(MIN_RAM, Long.toString(ram));
      return this;
   }
   ...
   public ListImageOptions minDisk(long disk) {
      queryParameters.put(MIN_DISK, Long.toString(disk));
      return this;
   }

   /**
    * Return those images that have a size attribute greater than or equal to
    * size
    */
   public ListImageOptions minSize(long size) {
      queryParameters.put(SIZE_MIN, Long.toString(size));
      return this;
   }
   ...
   public ListImageOptions maxSize(long size) {
      queryParameters.put(SIZE_MAX, Long.toString(size));
      return this;
   }
   ...
   public ListImageOptions isPublic(boolean isPublic) {
      queryParameters.put(IS_PUBLIC, Boolean.toString(isPublic));
      return this;
   }
   ...
   public ListImageOptions isProtected(boolean isProtected) {
      queryParameters.put(PROTECTED, Boolean.toString(isProtected));
      return this;
   }
    ...
    */
   public ListImageOptions sortBy(String key) {
      // TODO: Before key was part of the enum that contained possible
      // options...
      queryParameters.put("sort_key", key);
      return this;
   }
   ...
   public static class Builder {
       ...
       * @see ListImageOptions#sortBy
       */
      public static ListImageOptions sortBy(String sortKey) {
         // TODO: Same here, look in ImageField
