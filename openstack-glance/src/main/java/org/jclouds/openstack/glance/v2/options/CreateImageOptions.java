...
public class CreateImageOptions implements MapBinder {
   ...
   /**
    * Set name {@value org.jclouds.openstack.glance.v2.domain.Image#NAME}
    */
   ...
   /**
    * Set visibility
    * {@value org.jclouds.openstack.glance.v2.domain.Image#VISIBILITY}
    * 
    */
   ...
   /**
    * Set tags {@value org.jclouds.openstack.glance.v2.domain.Image#TAGS}
    * 
    * @return
    */
   ...
   /**
    * Set disk format
    * {@value org.jclouds.openstack.glance.v2.domain.Image#DISK_FORMAT}
    */
    ...
    * {@value org.jclouds.openstack.glance.v2.domain.Image#CONTAINER_FORMAT}
    */
